...
class ContactManager:
    def __init__(self, root):
        ...
        title = Label(self.root, text="ContactBook ", font=( "Comic Sans MS", 20, ), bd=8,  bg='black', fg='white')
        ...
        lbl_mob = Label(Detail_F, text="lastname",
                        font=("Comic Sans MS", 12, ))
        ...
        self.contact_table.heading("lastname", text="lastname")
...
class Login():
    ...
    def login(self):
        ...
        if self.username.get() == "meghana" and self.password.get() == "megha":
...
cur.execute('create table if not exists contact (firstname varchar(20),email varchar(20),mobile varchar(20) primary key , addr varchar(20) , pin varchar(20))')
